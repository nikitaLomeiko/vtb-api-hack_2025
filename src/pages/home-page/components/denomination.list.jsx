...
export const DenominationList = () => {
  ...
  const calculateDenominations = (balance) => {
    const denominations = [
      ...
      },
      {
        value: 2000,
        color:
          'bg-(--bg-tertiary) text-(--accent-primary) border border-(--border-primary)',
      },
      {
        value: 1000,
        color:
          'bg-(--bg-tertiary) text-green-600 border border-(--border-primary)',
      },
      {
        value: 500,
        color:
          'bg-(--bg-tertiary) text-yellow-600 border border-(--border-primary)',
      },
      {
        value: 100,
        color:
  ...
  return (
    <div className="my-5 ">
      <p className="text-(--text-secondary) text-sm font-medium mb-4 text-center">
        Номиналы в обороте
      </p>
