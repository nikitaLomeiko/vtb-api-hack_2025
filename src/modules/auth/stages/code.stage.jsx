          ...
          <div className="flex justify-center space-x-3 mb-2">
            {[...Array(6)].map((_, index) => (
              <input
                ...
                onPaste={handlePaste}
                className="w-12 h-12 text-center text-xl font-semibold border-2 border-(--border-primary) rounded-lg focus:ring-2 focus:ring-(--accent-primary) focus:border-(--accent-primary) transition-colors bg-(--bg-primary) text-(--text-primary)"
                disabled={isLoading}
              />
            ))}
          </div>
