...
export const BankLoadingScreen = memo(({ onLoadingComplete }) => {
  ...
  return (
    <div
      className={`
      min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className={`
          absolute top-1/4 left-1/4 w-48 h-48 bg-gradient-to-r from-blue-500 to-cyan-400 
        ...
        <div
          className={`
          absolute bottom-1/3 right-1/4 w-32 h-32 bg-gradient-to-r from-purple-500 to-pink-400 
          rounded-full opacity-20 blur-lg
      ...
      >
        ...
        <div className="flex justify-center mb-4">
          <div className="relative">
            <div
              className={`
              w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl 
