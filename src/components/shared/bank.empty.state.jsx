...
export const BankEmptyState = ({ onAddBank }) => {
  return (
    <div className="text-center py-8 md:py-12">
      ...
      <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Нет добавленных банков</h3>
      <p className="text-gray-500 mb-4 md:mb-6 text-sm md:text-base">Добавьте ваш первый банк чтобы начать работу</p>
      <button 
        onClick={onAddBank}
      ...
      >
        ...
        <span className="font-semibold text-base md:text-lg">Добавить первый банк</span>
      </button>
    </div>
  );
};