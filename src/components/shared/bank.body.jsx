            ...
            accounts.map((account, accIndex) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-(--bg-tertiary) to-(--bg-secondary) rounded-xl flex items-center justify-center border border-(--border-primary) flex-shrink-0">
