  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-semibold text-gray-800">История транзакций</h2>
      </div>
      ...
      <div className="divide-y divide-gray-100">
        {transaction.tansactionList.length === 0 ? (
          ...
          transaction.tansactionList.map((trans) => (
            <div key={trans.transactionId} className="px-6 py-4 hover:bg-gray-50 transition-colors">
