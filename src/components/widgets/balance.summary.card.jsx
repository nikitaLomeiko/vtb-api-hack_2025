  ...
  return (
    <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-1/4 left-1/4 w-4 h-4 md:w-6 md:h-6 rounded-full bg-blue-300/30 animate-float-wide-1"
          style={{ animation: 'floatWide1 15s infinite linear' }}
        />
        <div
          className="absolute top-3/4 left-1/3 w-3 h-3 md:w-5 md:h-5 rounded-full bg-blue-400/40 animate-float-wide-2"
          style={{ animation: 'floatWide2 18s infinite linear' }}
        />
        <div
          className="absolute top-1/3 left-3/4 w-5 h-5 md:w-7 md:h-7 rounded-full bg-purple-300/35 animate-float-wide-3"
          style={{ animation: 'floatWide3 12s infinite linear' }}
        />
        <div
          className="absolute top-2/3 left-1/6 w-2 h-2 md:w-4 md:h-4 rounded-full bg-blue-500/45 animate-float-wide-4"
          style={{ animation: 'floatWide4 20s infinite linear' }}
        />
        <div
          className="absolute top-1/6 left-2/3 w-4 h-4 md:w-6 md:h-6 rounded-full bg-purple-400/30 animate-float-wide-5"
          style={{ animation: 'floatWide5 16s infinite linear' }}
        />
        <div
          className="absolute top-4/5 left-4/5 w-3 h-3 md:w-5 md:h-5 rounded-full bg-blue-600/35 animate-float-wide-6"
          style={{ animation: 'floatWide6 14s infinite linear' }}
        />
        <div
          className="absolute top-1/2 left-1/8 w-4 h-4 md:w-6 md:h-6 rounded-full bg-purple-500/25 animate-float-wide-7"
          style={{ animation: 'floatWide7 22s infinite linear' }}
        />
        <div
          className="absolute top-1/8 left-1/2 w-2 h-2 md:w-4 md:h-4 rounded-full bg-blue-300/40 animate-float-wide-8"
      ...
      <div className="relative flex justify-center items-center mb-12 md:mb-16">
        ...
        <div className="absolute flex items-center justify-center">
          <div
            className="absolute w-64 h-64 md:w-80 md:h-80 rounded-full bg-blue-400/25 animate-pulse"
            style={{ animation: 'pulse 4s infinite' }}
          />
          <div
            className="absolute w-56 h-56 md:w-64 md:h-64 rounded-full bg-blue-500/30 animate-pulse"
            style={{ animation: 'pulse 3.5s infinite 0.3s' }}
          />
          <div
            className="absolute w-32 h-32 md:w-48 md:h-48 rounded-full bg-blue-600/35 animate-pulse"
