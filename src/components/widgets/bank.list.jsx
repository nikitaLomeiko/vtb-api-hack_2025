...
export const BanksList = ({ onAddBank, onBankClick }) => {
  ...
  const totalAccounts = bank.bankList.reduce((total, bankItem) => 
    total + bankItem.accounts.length, 0
  );
  ...
  return (
    <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-gray-900">Мои банки</h2>
      ...
      {bank.bankList.length === 0 && (
        <BankEmptyState onAddBank={onAddBank} />
      )}
